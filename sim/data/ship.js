...
export const SHIP = {
  ...
  nodes: [
    ...
    { id: 'mess', name: 'Mess Hall', deck: 2, foreAft: 0.36, type: 'open', capacity: 28, w: 18, d: 12, roles: ['soft'] },
    { id: 'galley', name: 'Galley', deck: 2, foreAft: 0.44, type: 'room', capacity: 8, w: 10, d: 8, roles: ['soft'] },
    { id: 'd2store', name: 'Deck 2 Stores', deck: 2, foreAft: 0.49, type: 'room', capacity: 5, w: 8, d: 6, roles: ['cargo'] },
    { id: 'medbay', name: 'Medbay', deck: 2, foreAft: 0.52, type: 'room', capacity: 12, w: 14, d: 10, roles: ['medbay', 'helpless', 'corpse_cache', 'soft'] },
    { id: 'brig', name: 'Brig', deck: 2, foreAft: 0.58, type: 'room', capacity: 4, w: 8, d: 6, roles: ['brig', 'helpless'] },
    { id: 'cryo', name: 'Cryo Bay', deck: 2, foreAft: 0.62, type: 'room', capacity: 10, w: 14, d: 10, roles: ['cryo', 'corpse_cache'] },
    { id: 'chapel', name: 'Chapel', deck: 2, foreAft: 0.68, type: 'room', capacity: 6, w: 8, d: 7, roles: ['soft'] },
    { id: 'd2corrF', name: 'Hab Corridor Fore', deck: 2, foreAft: 0.33, type: 'corridor', capacity: 8, w: 44, d: 3, roles: ['artery'] },
    { id: 'd2corrA', name: 'Hab Corridor Aft', deck: 2, foreAft: 0.55, type: 'corridor', capacity: 8, w: 48, d: 3, roles: ['artery'] },
    // ---- deck 3 · operations ----
    { id: 'corrF', name: 'Main Corridor Fore', deck: 3, foreAft: 0.25, type: 'corridor', capacity: 10, w: 48, d: 3.5, roles: ['artery'] },
    { id: 'corrM', name: 'Main Corridor Mid', deck: 3, foreAft: 0.50, type: 'corridor', capacity: 10, w: 48, d: 3.5, roles: ['artery'] },
    { id: 'corrA', name: 'Main Corridor Aft', deck: 3, foreAft: 0.75, type: 'corridor', capacity: 10, w: 48, d: 3.5, roles: ['artery'] },
    { id: 'gym', name: 'Gymnasium', deck: 3, foreAft: 0.30, type: 'room', capacity: 8, w: 12, d: 9, roles: ['soft'] },
    { id: 'armory', name: 'Armory', deck: 3, foreAft: 0.40, type: 'room', capacity: 8, w: 10, d: 8, roles: ['armory', 'armed'] },
    { id: 'security', name: 'Security', deck: 3, foreAft: 0.45, type: 'room', capacity: 10, w: 12, d: 9, roles: ['marines'] },
    { id: 'stores3', name: 'Deck 3 Stores', deck: 3, foreAft: 0.55, type: 'room', capacity: 5, w: 8, d: 6, roles: ['cargo'] },
    { id: 'barracks', name: 'Barracks', deck: 3, foreAft: 0.60, type: 'room', capacity: 16, w: 18, d: 12, roles: ['marines', 'odst'] },
    { id: 'workshop', name: 'Workshop', deck: 3, foreAft: 0.66, type: 'room', capacity: 8, w: 12, d: 9, roles: ['maintenance'] },
    { id: 'podPort', name: 'Lifepod Bay Port', deck: 3, foreAft: 0.71, type: 'room', capacity: 10, w: 14, d: 8, roles: ['lifepods', 'objective'] },
    { id: 'podStbd', name: 'Lifepod Bay Stbd', deck: 3, foreAft: 0.79, type: 'room', capacity: 10, w: 14, d: 8, roles: ['lifepods', 'objective'] },
    // ---- deck 4 · flight & cargo ----
    { id: 'maintF', name: 'Maintenance Fore', deck: 4, foreAft: 0.36, type: 'corridor', capacity: 6, w: 26, d: 2.5, roles: ['maintenance'] },
    { id: 'pumpRoom', name: 'Pump Room', deck: 4, foreAft: 0.42, type: 'room', capacity: 5, w: 8, d: 7, roles: ['maintenance', 'systems'] },
    { id: 'hangar', name: 'Hangar Fore', deck: 4, foreAft: 0.50, type: 'open', capacity: 30, w: 34, d: 20, roles: ['hangar', 'large', 'crash_candidate'] },
    { id: 'hangarCtl', name: 'Hangar Control', deck: 4, foreAft: 0.56, type: 'room', capacity: 5, w: 8, d: 6, roles: ['systems'] },
    { id: 'hangarA', name: 'Hangar Aft', deck: 4, foreAft: 0.63, type: 'open', capacity: 30, w: 34, d: 20, roles: ['hangar', 'large', 'crash_candidate'] },
    { id: 'vehicle', name: 'Vehicle Bay', deck: 4, foreAft: 0.72, type: 'open', capacity: 24, w: 28, d: 16, roles: ['vehicles', 'crash_candidate'] },
    { id: 'd4store', name: 'Flight Stores', deck: 4, foreAft: 0.77, type: 'room', capacity: 5, w: 8, d: 6, roles: ['cargo'] },
    { id: 'cargo1', name: 'Cargo Hold 1', deck: 4, foreAft: 0.83, type: 'room', capacity: 18, w: 22, d: 14, roles: ['cargo', 'crash_candidate'] },
    { id: 'cargo2', name: 'Cargo Hold 2', deck: 4, foreAft: 0.91, type: 'room', capacity: 18, w: 22, d: 14, roles: ['cargo', 'crash_candidate'] },
    // ---- deck 5 · engineering ----
    { id: 'lowerCorr', name: 'Lower Corridor', deck: 5, foreAft: 0.60, type: 'corridor', capacity: 10, w: 56, d: 3, roles: ['artery'] },
    { id: 'pumps', name: 'Coolant Plant', deck: 5, foreAft: 0.50, type: 'room', capacity: 5, w: 10, d: 8, roles: ['systems', 'maintenance'] },
    { id: 'lifesup', name: 'Life Support', deck: 5, foreAft: 0.66, type: 'room', capacity: 8, w: 12, d: 9, roles: ['systems'] },
    { id: 'd5store', name: 'Engineering Stores', deck: 5, foreAft: 0.72, type: 'room', capacity: 5, w: 8, d: 6, roles: ['cargo'] },
    { id: 'eng', name: 'Engineering', deck: 5, foreAft: 0.79, type: 'room', capacity: 12, w: 18, d: 12, roles: ['engineering', 'power'] },
    { id: 'reactor', name: 'Reactor', deck: 5, foreAft: 0.88, type: 'room', capacity: 8, w: 14, d: 12, roles: ['power', 'hazard'] },
    { id: 'maintA', name: 'Maintenance Aft', deck: 5, foreAft: 0.94, type: 'corridor', capacity: 6, w: 20, d: 2.5, roles: ['maintenance', 'crash_candidate'] },
  ],
  edges: [
    // deck 1
